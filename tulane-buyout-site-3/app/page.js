...
const HERO = 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Yulman_Stadium_-_Tulane_Green_Wave_%2855143965690%29.jpg/1920px-Yulman_Stadium_-_Tulane_Green_Wave_%2855143965690%29.jpg';
const ACTION = 'https://commons.wikimedia.org/wiki/Special:Redirect/file/Tulane_Green_Wave_football_takes_the_field_(2014).jpg?width=2200';
...
export default function Page() {
  return (
    <main>
      ...
      <div className="photo-credit">Yulman Stadium photo: <a href="https://commons.wikimedia.org/wiki/File:Yulman_Stadium_-_Tulane_Green_Wave_(55143965690).jpg" target="_blank">ajay_suresh / Wikimedia Commons</a> • CC BY 4.0 • dark overlay/crop applied</div>
...
<CampaignProgress />
      ...
      <section className="image-band" style={{backgroundImage:`linear-gradient(rgba(0,61,47,.18),rgba(0,61,47,.76)),url(${ACTION})`}}><div><span>THIS IS ABOUT THE STANDARD</span><h2>Tulane just reached the College Football Playoff. Supporters believe championship expectations should remain the expectation.</h2></div></section>
      <div className="photo-credit">Tulane taking the field at Yulman Stadium: <a href="https://commons.wikimedia.org/wiki/File:Tulane_Green_Wave_football_takes_the_field_(2014).jpg" target="_blank">Vegasjon / Wikimedia Commons</a> • CC BY-SA 4.0 • dark overlay/crop applied</div>
